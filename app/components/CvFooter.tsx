  ...
  useEffect(() => {
    fetch('/api/geo')
      ...
      .then((data) => {
        ...
        setActivities((data.activities || []).filter((a: GeoActivity) => a.clubs > 0));
      })
      .catch(() => {});
  }, []);
      ...
      <div className="wrap">
        <div className="foot-top">
          ...
          <div className="foot-cols">
            <div className="foot-col"><h4>Explorer</h4><Link href="/#supports">Supports</Link><Link href="/#regions">La carte des régions</Link><Link href="/search">Tous les clubs</Link></div>
